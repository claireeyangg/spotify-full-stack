...
import pause_circle from './pause_circle.png'
...
export const albumsData = [
    // each object represents one album (each has: album id, name, image, description, and bgColor)
    {   
        id:0,
        name: "Top 50 Global",
        image: img8,
...
// each object represents one song (id, name, image, file name, description, duration)
    {
        id:0,
        name: "Song One",
        image: img1,
